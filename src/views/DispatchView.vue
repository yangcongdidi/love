<template>
    <div class="page">
        ...
        <div class="group">
            ...
            <div><input @blur="vailPhone" v-model="phone" type="text" placeholder="请输入手机号码"></div>
        </div>
        <div class="group">
...
<script>
    ...
    export default {
        ...
        methods:{
            Dispatch() {
                console.log(this.vailUserName())
                console.log(this.vailPhone())
                console.log(this.vailAddress())
                if(this.vailUserName()==true && this.vailPhone()==true && this.vailAddress()==true && this.vailDate()==true ){
                    this.$store.commit('setRecipients',this.username)
